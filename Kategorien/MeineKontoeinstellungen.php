      ...
      <header> 
                  <nav class="navbar navbar-default ">
                        <div class="container-fluid"><!-- padding: 15px 15px 25px 15px; -->
                               ...
                               <form action="Buttons/Hilfsdokumente/Artikelsuche.php" method="post"  class="navbar-form navbar-left "  >
...
<div class="tabStyle">
                                                <br>
                                                <h4 style="text-align: center; font-weight: bold">Meine Kontoeinstellungen</h4>  
                                                <br>
