...
<!-- Überschriften -->                      
                 <ul class="nav nav-pills nav-stacked">  
                      ...
                      <div class="head2" role="tab" id="KontoHead">
                                          ...
                                          <li role="Konto"><a href="MeineKontodate.php" >Meine Kontodaten</a></li>
...
<!-- Inhalte -->          
                              ...
                              <div class='row' style="   display: flex; align-items: center;  justify-content: center;" >
                                        <div class="col-md-3" style="width: 180px; height: 180px;">
                                            <a href="MeineNachrichten.php" class="BilderDarstellungMenue" >
                                                <span class="glyphicon glyphicon-envelope" aria-hidden="true" style="font-size:100px;  padding-top:10%;"></span>
                                                <h5 style=" text-align: center; padding-bottom: 5%;"> Nachrichten </h5>
                                            </a>
                                        </div>
                                        ...
                                        <div class="col-md-3" style="width: 180px; height: 180px;">
                                         ...
                                         <div class="col-md-3" style="width: 180px; height: 180px; ">                               
                                              <a href="Warenkorb.php" class="BilderDarstellungMenue">
                                                <span class="glyphicon glyphicon-shopping-cart"   aria-hidden="true" style="font-size:100px;  padding-top:10%;"></span>
                                                <h5 style="text-align: center; padding-bottom: 5%;">Warenkorb</h5>
                                              </a>
                                        </div> <!-- col 4-->

                                        <div class="col-md-3" style="width: 180px; height: 180px; ">                               
                                              <a href="Forum.php" class="BilderDarstellungMenue" >
                                                <span class="glyphicon glyphicon-comment" aria-hidden="true" style="font-size:100px;  padding-top:10%;"></span>
                                                <h5 style="text-align: center; padding-bottom: 5%;">Forum</h5>
                                              </a>
                                        </div> <!-- col 4-->
                              </div><!--row-->
                              ...
                              <div class='row' style="  display: flex; align-items: center;  justify-content: center;">
                                        <div class="col-md-3" style="width: 180px; height: 180px;  "> 
                                            <a href="Buttons/Hilfsdokumente/VerkaufsartikelKommunikation.php" class="BilderDarstellungMenue">
                                              <span class="glyphicon glyphicon-book" aria-hidden="true" style="font-size:100px; padding-top:15%;"></span>
                                              <h5 style="text-align: center; padding-bottom: 5%;">Meine Verkaufsartikel</h5>
                                            </a>
                                         </div> <!-- col 4-->                                
                                                                                
                                         <div class="col-md-3" style="width: 180px; height: 180px;">                               
                                              <a href="MeineBestellungen.php"  class="BilderDarstellungMenue" >
                                                <span class="glyphicon glyphicon-list-alt" aria-hidden="true" style="font-size:100px;  padding-top:15%;"></span>
                                                <h5 style="text-align: center; padding-bottom: 5%;">Meine Bestellungen</h5>
                                              </a>
                                        </div> <!-- col 4-->

                                            <div class="col-md-3" style="width: 180px; height: 180px;  ">                               
                                              <a href="MeineKontodaten.php" class="BilderDarstellungMenue">
                                                <span class="glyphicon glyphicon-user" aria-hidden="true" style="font-size:100px; padding-top:15%;"></span>
                                                <h5 style="text-align: center; padding-bottom: 5%;">Meine Kontodaten</h5>
                                              </a>
                                        </div> <!-- col 4-->

                                         <div class="col-md-3" style="width: 180px; height: 180px;">                               
                                              <a href="MeineWatchlist.php" class="BilderDarstellungMenue">
                                                <span class="glyphicon glyphicon-eye-open" aria-hidden="true" style="font-size:100px;  padding-top:15%;"></span>
                                                <h5 style="text-align: center; padding-bottom: 5%;">Meine Watchlist</h5>
                                              </a>
                                        </div> <!-- col 4-->
                              </div><!--row-->
