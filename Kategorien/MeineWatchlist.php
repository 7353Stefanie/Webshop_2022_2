            ...
            <div class="col-md-8" style="margin-left: 27%;"> 
                                    ...
                                    <div class="tabStyle">
                                             ...
                                             <!-- <h9>
                                              ...
                                              Sollte ein Anwender, an einem Artikel interessiert sein, der noch nicht von anderen Anbietern hinzugefügt wurde, kann dieser Artikel auf eine perönliche Watchlist gestellt werden. Sollte dieser Artikel auf der Watchlist irgendwann von einem Anbieter angeboten werden, bekommt der Anwender der diesen Artikel in der Watchlist hat eine Mitteilung.
                                              ...
                                              Artikel beim Start:
                                                  ...
                                                  <table class="table">
                                                       ...
                                                       <tr  style=" font-weight: bold; font-size: 12px;">
                                                          <td>Artikel</td>
                                                          <td> Bild</td>
                                                          <td><button type="button" style="font-size: 12px; float: right;" class="btn btn-default" aria-label="Links ausrichten">
