...
<html lang="de">
  <head>
            ...
            <link rel="stylesheet" href="Hilfsdokumente/bootstrap-theme.min.css">
             <link rel="stylesheet" href="Hilfsdokumente/bootstrap.css">
...
<!-- Überschriften -->                      
                 <ul class="nav nav-pills nav-stacked">  
                      ...
                      <div class="head2" role="tab" id="KontoeinstellungenHead">
                                          ...
                                          <li role="Kontoeinstellungen"><a  href="../Kontoeinstellungen.php" >Kontoeinstellungen</a></li>
...
<!-- Inhalte -->     
                                    <div class="tabStyle">
                                                ...
                                                <div style=" display: inline-table; padding-left: 140px;   ">
                                                 <button  type="submit" class="btn btn-default" style="display: inline-table;"  ><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>  Daten speichern</button>
                                                </div>
                                            ...
                                            $query = sprintf( "SELECT Benutzername, Vorname, Nachname, EMail FROM benutzer WHERE idBenutzer = '%s'",
                                                               $mysqli->real_escape_string($_SESSION['idBenutzer'])
                                                                  );

                                            $query2 = sprintf( "SELECT  Strasse, Hausnummer, Ort FROM  adresse WHERE idBenutzer = '%s'",
                                                               $mysqli->real_escape_string($_SESSION['idBenutzer'])
                                                                  );
                                                  ...
                                                  $zeile = $result->fetch_array(MYSQLI_ASSOC);
                                                   $zeile2 = $result2->fetch_array(MYSQLI_ASSOC);
                                                    ...
                                                    echo '<tr  >';
                                                      ...
                                                      echo '<td>';
                                                       echo ' <input type="text" class="form-control" value="'. $zeile['Benutzername'].'" aria-describedby="einfaches-addon1">' ;
                                                      echo '</td>';
                                                       ...
                                                       echo ' <input type="text" class="form-control" value="'. $zeile['Vorname'].'" aria-describedby="einfaches-addon1">' ;
                                                   ...
                                                   echo '<tr >';
                                                      ...
                                                      echo '<td>';
                                                         echo ' <input type="text" class="form-control" value="'. $zeile['EMail'].'" aria-describedby="einfaches-addon1">' ; 
                                                      echo '</td>';
                                                       ...
                                                       echo '<td>';
                                                         ...
                                                         echo '<td>';
                                                            ...
                                                            echo ' <input type="text" class="form-control" value="'. $zeile['Nachname'].'" aria-describedby="einfaches-addon1">' ; 
                                                          echo '</td>'; 
                                                 ...
                                                 echo '<tr>';
                                                         ...
                                                         echo '</td>';
                                                          ...
                                                          echo '<td>';
                                                           ...
                                                           echo ' <input type="text" class="form-control" value="'.$zeile2["Ort"].'" aria-describedby="einfaches-addon1">' ; 
                                                          echo '</td>'; 
                                                  ...
                                                  echo '<tr>';
                                                         ...
                                                         echo '<td>';
                                                           echo ' <input type="text" class="form-control" value="'.$zeile2["Straße"].'" aria-describedby="einfaches-addon1">' ; 
                                                        //    echo ;
                                                          echo '</td>';  
                                                    echo '</tr>';
